...
- **Primary Red**: Safety Red (#EE3124) - *OILFIELD branding & CTAs*
- **Accent Color**: Industrial Gold (#FFCC00) - *Metrics, Icons & Highlights*
- **Background**: White (#FFFFFF) with Deep Slate (#1E293B) text.
- **Typography**: Montserrat (Bold/ExtraBold) for Headers, Inter/System-UI for body.
...
- **Icons**: Lucide React
- **Deployment Strategy**: Server-side stability focused with optimized LCP assets.
...
- `Profile (/profile)`: Corporate mission, vision, and operational scale.
- `Routes`: Placeholder logic for Services, Rental, Certifications, Clients, and Contact.
