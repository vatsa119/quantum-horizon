  ...
  return (
    <div className="fixed right-[var(--space-12)] top-1/2 -translate-y-1/2 z-[100] hidden lg:flex flex-col space-y-[var(--space-10)]">
      {sections.map((section) => (
        ...
        >
          <span className={`text-tech-label transition-all duration-500 whitespace-nowrap ${activeSection === section.id ? 'opacity-100 text-[var(--signal-red-500)] translate-x-0' : 'opacity-0 -translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 text-[var(--neutral-400)]'}`}>
            {section.label}
          </span>
...
export default function ProfilePage() {
  ...
  return (
    <main className="bg-white min-h-screen relative overflow-x-hidden font-sans">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-[var(--space-12)] lg:gap-[var(--space-24)] items-center">
            <div className="lg:col-span-12 space-y-[var(--space-8)] mb-[var(--space-12)] border-b border-[var(--neutral-100)] pb-[var(--space-12)]">
              ...
              >
                ...
                <span className="text-tech-label text-[var(--signal-red-500)]">Operational Intelligence</span>
              </motion.div>
              <h1 className="text-display-lg lg:text-[9rem] text-[var(--carbon-black)] uppercase tracking-tighter leading-[0.85]">
                UNVEILING <br />
            ...
            <div className="lg:col-span-6 space-y-[var(--space-8)]">
              <p className="text-h3 text-[var(--neutral-600)] leading-relaxed italic border-l-4 border-[var(--signal-red-500)] pl-6">
                Sigma bridges the gap between technical demand and executive reliability across global energy corridors.
              </p>
              <div className="space-y-[var(--space-6)] text-body-lg text-[var(--neutral-500)] leading-relaxed font-medium">
                <p>
              ...
              <div className="relative h-[550px] rounded-[var(--radius-hud)] overflow-hidden shadow-2xl group image-reveal visible">
                ...
                <div className="absolute inset-0 p-[var(--space-10)] flex flex-col justify-end pointer-events-none">
                  <div className="bg-white/95 backdrop-blur-2xl p-[var(--space-6)] rounded-2xl border border-[var(--signal-red-500)]/20 shadow-2xl w-fit">
                    <span className="text-tech-label text-[var(--signal-red-500)] block mb-1">Registry ID: SI-DR-024</span>
                    <h3 className="text-h4 text-[var(--carbon-black)] uppercase tracking-tighter">Integrated Rig Performance</h3>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-[var(--space-12)] lg:gap-[var(--space-24)] items-center">
            <div className="lg:col-span-12 mb-[var(--space-8)] flex items-center justify-between">
              <div className="flex items-center space-x-[var(--space-3)]">
                <div className="w-[var(--space-12)] h-[2px] bg-[var(--signal-red-500)]" />
                <span className="text-tech-label text-[var(--signal-red-500)]">Refurbishment Lifecycle</span>
              </div>
              <span className="text-tech-label text-[var(--neutral-300)]">PROTOCOL: REBIRTH_V4</span>
            </div>

            <div className="lg:col-span-12 xl:col-span-5 space-y-[var(--space-8)]">
              <h2 className="text-display-md text-[var(--carbon-black)] uppercase tracking-tighter leading-[0.9]">
                Asset <br />
              ...
              <div className="space-y-[var(--space-4)]">
                {[
                  ...
                  <RevealItem key={i} delay={i * 0.1} className="flex items-center space-x-4 p-4 bg-white rounded-xl border border-[var(--neutral-100)] shadow-sm">
                    <div className="w-10 h-10 rounded-lg bg-[var(--neutral-50)] flex items-center justify-center text-[var(--signal-red-500)] font-black text-mono-sm">0{i + 1}</div>
                    <div>
                      <h4 className="text-overline text-[var(--carbon-black)]">{item.title}</h4>
                      <p className="text-mono-sm text-[var(--neutral-400)]">{item.desc}</p>
                    </div>
                  </RevealItem>
                ))}
              </div>
            ...
            <div className="lg:col-span-12 xl:col-span-7">
              <RevealItem delay={0.3} className="relative z-10">
                ...
                <div className="mt-6 text-center">
                  <span className="text-tech-label text-[var(--neutral-300)] animate-pulse underline decoration-[var(--signal-red-500)]/30 underline-offset-4">SLIDE TO REVEAL TRANSFORMATION</span>
                </div>
              </RevealItem>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-[var(--space-20)] items-center">
            <div className="space-y-[var(--space-8)]">
              <div className="flex items-center space-x-[var(--space-3)]">
                ...
                <span className="text-tech-label text-[var(--industrial-gold)]">Guiding Command</span>
              </div>
              <h2 className="text-display-lg text-[var(--carbon-black)] uppercase tracking-tighter leading-[0.9] slide-in-left visible">
                MISSION <br />
                <span className="text-[var(--industrial-gold)]">CRITICAL</span>
              </h2>
              <div className="relative">
                <p className="text-h4 text-[var(--neutral-500)] leading-relaxed italic max-w-lg">
            ...
            <div className="relative flex justify-center">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                ...
                >
                  ...
                  <span className="text-tech-label font-black text-[var(--carbon-black)]">EXECUTIVE ALIGNMENT</span>
                </motion.div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-[var(--space-8)] lg:px-[var(--space-24)]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-[var(--space-20)] items-center">
            <div className="space-y-[var(--space-8)] reveal-item visible">
              <div className="flex items-center space-x-[var(--space-3)]">
                <div className="w-[var(--space-12)] h-[2px] bg-[var(--signal-red-500)]" />
                <span className="text-tech-label text-[var(--signal-red-500)]">Performance Matrix</span>
              </div>
              <h2 className="text-display-lg text-[var(--carbon-black)] uppercase tracking-tighter leading-[0.9]">
                Elevating <br />
              ...
              <p className="text-h4 text-[var(--neutral-500)] leading-relaxed font-medium">
                Sigma FZCO bridges the gap between demand and supply, ensuring a <span className="text-[var(--carbon-black)] font-[900]">95% on-time delivery rate</span> across 42 active sectors.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-l-2 border-[var(--signal-red-500)]/20 pl-8">
                {["High-Performance Lube", "API Certified PPE", "Industrial Chemicals", "Rig Spares", "Fluid Additives"].map((item, idx) => (
                  <motion.div
                    ...
                    className="flex items-center space-x-3 text-tech-label text-[var(--neutral-600)]"
                  >
            ...
            <div className="relative h-[500px] bg-[var(--neutral-50)] rounded-[var(--radius-hud)] flex flex-col items-center justify-center border border-[var(--neutral-100)] shadow-inner overflow-hidden group">
              <div className="text-center z-10">
                ...
                <span className="text-tech-label text-[var(--neutral-400)] mt-4 block">PERFORMANCE INDEX [ACTIVE]</span>
              </div>
              <motion.div
          ...
          <div className="bg-white rounded-[var(--radius-hud)] p-[var(--space-10)] lg:p-[var(--space-16)] shadow-2xl border border-[var(--neutral-100)] relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-[var(--space-16)] items-center relative z-10">
              <div className="space-y-[var(--space-8)]">
                ...
                <h3 className="text-display-md text-[var(--carbon-black)] uppercase tracking-tighter leading-none slide-in-left visible">QUALITY <br /> ACCREDITATION</h3>
                ...
                <div className="flex flex-wrap gap-3 pt-6">
                  {["API-7K Certified", "API-16A Compliant", "ISO 9001:2015", "HSE Compliant"].map(tag => (
                    <span key={tag} className="px-4 py-2 bg-[var(--neutral-50)] text-tech-label border border-[var(--neutral-200)] rounded-xl text-[var(--carbon-black)] transition-colors hover:bg-[var(--signal-red-500)] hover:text-white hover:border-[var(--signal-red-500)] cursor-default">{tag}</span>
                  ))}
                </div>
              </div>
              <div className="relative h-[480px] rounded-3xl overflow-hidden bg-[var(--neutral-50)] shadow-inner group">
                ...
                <div className="absolute bottom-6 right-6 p-4 bg-white/80 backdrop-blur-md rounded-2xl border border-white shadow-xl text-center min-w-[140px]">
                  <span className="text-mono-sm text-[var(--neutral-400)] block">PRECISION LEVEL</span>
      ...
      <ScrollySection id="vision" className="pt-24 pb-32 px-8 lg:px-24 section-dark text-white relative overflow-hidden scroll-mt-24 font-sans bg-[var(--carbon-black)]">
        ...
        <div className="max-w-7xl mx-auto px-[var(--space-8)] lg:px-[var(--space-24)] relative z-10 text-center lg:text-left">
          <RevealItem className="flex items-center space-x-[var(--space-4)] mb-[var(--space-10)] justify-center lg:justify-start">
            <div className="w-[var(--space-16)] h-[2px] bg-[var(--signal-red-500)]" />
            <span className="text-tech-label text-[var(--signal-red-500)]">Future Trajectory</span>
          </RevealItem>

          <RevealItem delay={0.2}>
            <h2 className="text-display-lg text-white uppercase tracking-tighter leading-[0.8] mb-[var(--space-10)]">
              VISION FOR <br />
          ...
          <RevealItem delay={0.4}>
            <p className="text-display-md text-[var(--neutral-400)] max-w-5xl font-display leading-[1.1] tracking-tight italic">
        ...
        {/* Kinetic Decor */}
        <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-[var(--signal-red-500)]/5 blur-[200px] -mr-96 -mt-96 rounded-full" />
      </ScrollySection>
